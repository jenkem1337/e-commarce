...
return array(
    'AbstractProductRepositoryMediatorComponent' => $baseDir . '/src/repository/repository_mediator/AbstractProductRepositoryMediatorComponent.php',
    'AggregateRoot' => $baseDir . '/src/model/AggregateRoot.php',
    'AllCategoryResponseDto' => $baseDir . '/src/dto/response_dto/AllCategoryResponseDto.php',
    'AllProductResponseDto' => $baseDir . '/src/dto/response_dto/AllProductResponseDto.php',
    'AllProductWithPaginationResponseDto' => $baseDir . '/src/dto/response_dto/AllProductWithPaginationResponseDto.php',
    'AllShippingMethodsResponseDto' => $baseDir . '/src/dto/response_dto/AllShippingMethodsResponseDto.php',
    ...
    'AuthControllerFactory' => $baseDir . '/src/controller/factory/AuthControllerFactory.php',
    'AuthService' => $baseDir . '/src/service/AuthService.php',
    'AuthServiceDecorator' => $baseDir . '/src/service/service_decorator/AuthService/AuthServiceDecorator.php',
    'AuthServiceImpl' => $baseDir . '/src/service/Implemantions/AuthServiceImpl.php',
    'BaseEntity' => $baseDir . '/src/model/BaseEntity.php',
    'BaseException' => $baseDir . '/src/exception/BaseException.php',
    'BaseExceptionTest' => $baseDir . '/src/tests/unit/exception/BaseExceptionTest.php',
    'CURLStringFile' => $vendorDir . '/symfony/polyfill-php81/Resources/stubs/CURLStringFile.php',
    'Category' => $baseDir . '/src/model/product/Category.php',
    'CategoryCollection' => $baseDir . '/src/model/product/iterator_aggregates/CategoryCollection.php',
    'CategoryCollectionTest' => $baseDir . '/src/tests/unit/iterator_aggregate/CategoryCollectionTest.php',
    'CategoryController' => $baseDir . '/src/controller/CategoryController.php',
    'CategoryControllerFactory' => $baseDir . '/src/controller/factory/CategoryControllerFactory.php',
    'CategoryCreatedResponseDto' => $baseDir . '/src/dto/response_dto/CategoryCreatedResponseDto.php',
    'CategoryCreationalDto' => $baseDir . '/src/dto/request_dto/CategoryCreationalDto.php',
    'CategoryDao' => $baseDir . '/src/data_acces_layer/CategoryDao.php',
    'CategoryDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/CategoryDaoImpl.php',
    'CategoryDeletedResponseDto' => $baseDir . '/src/dto/response_dto/CategoryDeletedResponseDto.php',
    'CategoryFactory' => $baseDir . '/src/model/product/factory/CategoryFactory.php',
    'CategoryInMemoryDaoImpl' => $baseDir . '/src/data_acces_layer/in_memory_implemantation/CategoryInMemoryImpl.php',
    'CategoryInMemoryDaoTest' => $baseDir . '/src/tests/integration/data_acces/category/CategoryInMemoryDaoTest.php',
    'CategoryInterface' => $baseDir . '/src/model/product/CategoryInterface.php',
    'CategoryNameChangedResponseDto' => $baseDir . '/src/dto/response_dto/CategoryNameChangedResponseDto.php',
    'CategoryRepository' => $baseDir . '/src/repository/CategoryRepository.php',
    'CategoryRepositoryImpl' => $baseDir . '/src/repository/Implemantions/CategoryRepositoryImpl.php',
    'CategoryService' => $baseDir . '/src/service/CategoryService.php',
    'CategoryServiceDecorator' => $baseDir . '/src/service/service_decorator/CategoryService/CategoryServiceDecorator.php',
    'CategoryServiceImpl' => $baseDir . '/src/service/Implemantions/CategoryServiceImpl.php',
    'CategoryTest' => $baseDir . '/src/tests/unit/model/category/CategoryTest.php',
    'ChangeForgettenPasswordCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/UserController/ChangeForgettenPasswordCommand.php',
    'ChangeFullNameCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/UserController/ChangeFullNameCommand.php',
    'ChangeFullNameDto' => $baseDir . '/src/dto/request_dto/ChangeFullNameDto.php',
    ...
    'ChangePasswordDto' => $baseDir . '/src/dto/request_dto/ChangePasswordDto.php',
    'ChangeProductBrandNameDto' => $baseDir . '/src/dto/request_dto/ChangeProductBrandNameDto.php',
    'ChangeProductDescriptionDto' => $baseDir . '/src/dto/request_dto/ChangeProductDescriptionDto.php',
    'ChangeProductHeaderDto' => $baseDir . '/src/dto/request_dto/ChangeProductHeaderDto.php',
    'ChangeProductModelNameDto' => $baseDir . '/src/dto/request_dto/ChangeProductModelNameDto.php',
    'ChangeProductPriceDto' => $baseDir . '/src/dto/request_dto/ChangeProductPriceDto.php',
    'ChangeProductStockQuantityDto' => $baseDir . '/src/dto/request_dto/ChangeProductStockQuantityDto.php',
    'Command' => $baseDir . '/src/front_controller/front_controller_command/Command.php',
    'Comment' => $baseDir . '/src/model/product/Comment.php',
    'CommentCollection' => $baseDir . '/src/model/product/iterator_aggregates/CommentCollection.php',
    'CommentDao' => $baseDir . '/src/data_acces_layer/CommentDao.php',
    'CommentDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/CommentDaoImpl.php',
    'CommentFactory' => $baseDir . '/src/model/product/factory/CommentFactory.php',
    'CommentInMemoryDaoImpl' => $baseDir . '/src/data_acces_layer/in_memory_implemantation/CommentInMemoryDaoImpl.php',
    'CommentInMemoryDaoTest' => $baseDir . '/src/tests/integration/data_acces/comment/CommentInMemoryDaoTest.php',
    'CommentInterface' => $baseDir . '/src/model/product/CommentInterface.php',
    'CommentRepository' => $baseDir . '/src/repository/CommentRepository.php',
    'CommentRepositoryImpl' => $baseDir . '/src/repository/Implemantions/CommentRepositoryImpl.php',
    'CommentTest' => $baseDir . '/src/tests/unit/model/comment/CommentTest.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'ConcreteCategoryFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteCategoryFactory.php',
    'ConcreteCommentFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteCommentFactory.php',
    'ConcreteImageFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteImageFactory.php',
    'ConcreteLongDistanceFactory' => $baseDir . '/src/model/shipping/factory/concrete/ConcreteLongDistanceFactory.php',
    'ConcreteProductCategoryCreationalModelFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteProductCategoryCreationalModelFactory.php',
    'ConcreteProductFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteProductFactory.php',
    'ConcreteProductSubscriberFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteProductSubscriberFactory.php',
    'ConcreteRateFactory' => $baseDir . '/src/model/product/factory/concrete/ConcreteRateFactory.php',
    'ConcreteRefreshTokenFactory' => $baseDir . '/src/model/user/factory/concrete/ConcreteRefreshTokenFactory.php',
    'ConcreteSameDayShippingFactory' => $baseDir . '/src/model/shipping/factory/concrete/ConcreteSameDayShippingFactory.php',
    'ConcreteTwoDayShippingFactory' => $baseDir . '/src/model/shipping/factory/concrete/ConcreteTwoDayShippingFactory.php',
    'ConcreteUserFactory' => $baseDir . '/src/model/user/factory/concrete/ConcreteUserFactory.php',
    'CrateNewCategoryCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/CategoryController/CrateNewCategoryCommand.php',
    'CreateNewProductCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/CreateNewProductCommand.php',
    'CreateNewProductSubscriberCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/CreateNewProductSubscriberCommand.php',
    'DatabaseConnection' => $baseDir . '/src/data_acces_layer/DatabaseConnections/DatabaseConnection.php',
    'DeleteCategoryByUuidCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/CategoryController/DeleteCategoryByUuidCommand.php',
    'DeleteCategoryDto' => $baseDir . '/src/dto/request_dto/DeleteCategoryDto.php',
    'DeleteImageByUuidDto' => $baseDir . '/src/dto/request_dto/DeleteImageByUuidDto.php',
    'DeleteImageCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ImageController/DeleteImageCommand.php',
    'DeleteProductByUuidDto' => $baseDir . '/src/dto/request_dto/DeleteProductByUuidDto.php',
    'DeleteProductCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/DeleteProductCommand.php',
    'DeleteProductSubscriberCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/DeleteProductSubscriberCommand.php',
    'DeleteProductSubscriberDto' => $baseDir . '/src/dto/request_dto/DeleteProductSubscriberDto.php',
    'DoesNotExistException' => $baseDir . '/src/exception/DoesNotExistException.php',
    'EmailService' => $baseDir . '/src/service/EmailService.php',
    'EmailServiceImpl' => $baseDir . '/src/service/Implemantions/EmailServiceImpl.php',
    'EmailSuccessfulyActivatedResponseDto' => $baseDir . '/src/dto/response_dto/EmailSuccessfulyActivatedResponseDto.php',
    'EmailVerificationDto' => $baseDir . '/src/dto/request_dto/EmailVerificationDto.php',
    'ErrorResponseDto' => $baseDir . '/src/dto/response_dto/ErrorResponseDto.php',
    'Factory' => $baseDir . '/src/factory/Factory.php',
    'FindAllCategoryCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/CategoryController/FindAllCategoryCommand.php',
    'FindAllCategoryDto' => $baseDir . '/src/dto/request_dto/FindAllCategoryDto.php',
    'FindAllProductCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/FindAllProductCommand.php',
    'FindAllProductWithPaginationCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/FindAllProductWithPaginationCommand.php',
    'FindAllProductWithPaginationDto' => $baseDir . '/src/dto/request_dto/FindAllProductWithPaginationDto.php',
    'FindAllProductsDto' => $baseDir . '/src/dto/request_dto/FindAllProductsDto.php',
    'FindAllShippingMethodDto' => $baseDir . '/src/dto/request_dto/FindAllShippingMethodDto.php',
    'FindAllShippingMethodsCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ShippingController/FindAllShippingMethodCommand.php',
    'FindCategoryByUuidDto' => $baseDir . '/src/dto/request_dto/FindCategoryByUuidDto.php',
    'FindOneCategoryCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/CategoryController/FindOneCategoryCommand.php',
    'FindOneProductByUuidDto' => $baseDir . '/src/dto/request_dto/FindOneProductByUuidDto.php',
    'FindOneProductByUuidListener' => $baseDir . '/src/message_queue_listener/FindOneProductByUuidListener.php',
    ...
    'FindOneShippingMethodCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ShippingController/FindOneShippingMethod.php',
    'FindOneShippingMethodDto' => $baseDir . '/src/dto/request_dto/FindOneShippingMethodDto.php',
    ...
    'ForgettenPasswordEmailCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/UserController/ForgettenPasswordEmailCommand.php',
    'ForgettenPasswordEmailDto' => $baseDir . '/src/dto/request_dto/ForgettenPasswordMailDto.php',
    'ForgettenPasswordEmailResponseDto' => $baseDir . '/src/dto/response_dto/ForgettenPasswordEmailResponseDto.php',
    'ForgettenPasswordResponseDto' => $baseDir . '/src/dto/response_dto/ForgettenPasswordResponseDto.php',
    'FrontController' => $baseDir . '/src/front_controller/FrontController.php',
    'FrontControllerTest' => $baseDir . '/src/tests/unit/front_controller/FrontControllerTest.php',
    'FullNameChangedResponseDto' => $baseDir . '/src/dto/response_dto/FullNameChagedResponseDto.php',
    ...
    'HttpMethodException' => $baseDir . '/src/exception/HttpMethodException.php',
    'Image' => $baseDir . '/src/model/product/Image.php',
    'ImageCollection' => $baseDir . '/src/model/product/iterator_aggregates/ImageCollection.php',
    'ImageController' => $baseDir . '/src/controller/ImageController.php',
    'ImageControllerFactory' => $baseDir . '/src/controller/factory/ImageControllerFactory.php',
    'ImageCreatedResponseDto' => $baseDir . '/src/dto/response_dto/ImageCreatedResponseDto.php',
    'ImageCreationalDto' => $baseDir . '/src/dto/request_dto/ImageCreationalDto.php',
    'ImageDao' => $baseDir . '/src/data_acces_layer/ImageDao.php',
    'ImageDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/ImageDaoImpl.php',
    'ImageDeletedResponseDto' => $baseDir . '/src/dto/response_dto/ImageDeletedResponseDto.php',
    'ImageFactory' => $baseDir . '/src/model/product/factory/ImageFactory.php',
    'ImageInMemoryDaoImpl' => $baseDir . '/src/data_acces_layer/in_memory_implemantation/ImageInMemoryDaoImpl.php',
    'ImageInMemoryDaoTest' => $baseDir . '/src/tests/integration/data_acces/image/ImageInMemoryDaoTest.php',
    'ImageInterface' => $baseDir . '/src/model/product/ImageInterface.php',
    'ImageRepository' => $baseDir . '/src/repository/ImageRepository.php',
    'ImageRepositoryImpl' => $baseDir . '/src/repository/Implemantions/ImageRepositoryImpl.php',
    'ImageService' => $baseDir . '/src/service/ImageService.php',
    'ImageServiceDecorator' => $baseDir . '/src/service/service_decorator/ImageService/ImageServiceDecorator.php',
    'ImageServiceImpl' => $baseDir . '/src/service/Implemantions/ImageServiceImpl.php',
    'ImageTest' => $baseDir . '/src/tests/unit/model/image/ImageTest.php',
    'IncorrectException' => $baseDir . '/src/exception/IncorrectException.php',
    'IsAdminMiddleware' => $baseDir . '/src/middleware/Auth/IsAdminMiddleware.php',
    'IsNotSamePropertyException' => $baseDir . '/src/exception/IsNotSamePropertyException.php',
    'JwtAuthMiddleware' => $baseDir . '/src/middleware/Auth/JwtAuthMiddleware.php',
    'JwtPayloadDto' => $baseDir . '/src/dto/request_dto/JwtPayloadDto.php',
    'LengthMustBeGreaterThanException' => $baseDir . '/src/exception/LengthMustBeGreaterException.php',
    'ListAllUserCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/UserController/ListAllUserCommand.php',
    'ListAllUserDto' => $baseDir . '/src/dto/request_dto/ListAllUserDto.php',
    'Listener' => $baseDir . '/src/message_queue_listener/Listener.php',
    'LoginCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/AuthController/LoginCommand.php',
    'LongDistanceShippingFactory' => $baseDir . '/src/model/shipping/factory/LongDistanceShippingFactory.php',
    'Middleware' => $baseDir . '/src/middleware/AbstractMiddleware.php',
    'MySqlPDOConnection' => $baseDir . '/src/data_acces_layer/DatabaseConnections/MySqlPDOConnection.php',
    'NegativeValueException' => $baseDir . '/src/exception/NegativeValueException.php',
    'NotActivatedException' => $baseDir . '/src/exception/NotActivatedException.php',
    'NotFoundException' => $baseDir . '/src/exception/NotFoundException.php',
    'NotMatchedException' => $baseDir . '/src/exception/NotMatchedException.php',
    'NotValidException' => $baseDir . '/src/exception/NotValidException.php',
    'NullCategory' => $baseDir . '/src/model/product/NullCategory.php',
    'NullComment' => $baseDir . '/src/model/product/NullComment.php',
    'NullException' => $baseDir . '/src/exception/NullException.php',
    'NullImage' => $baseDir . '/src/model/product/NullImage.php',
    'NullProduct' => $baseDir . '/src/model/product/NullProduct.php',
    'NullProductSubscriber' => $baseDir . '/src/model/product/NullProductSubscriber.php',
    'NullRate' => $baseDir . '/src/model/product/NullRate.php',
    'NullRefreshToken' => $baseDir . '/src/model/user/NullRefreshToken.php',
    'NullShipping' => $baseDir . '/src/model/shipping/NullShipping.php',
    'NullUser' => $baseDir . '/src/model/user/NullUser.php',
    'OneCategoryFoundedResponseDto' => $baseDir . '/src/dto/response_dto/OneCategoryFoundedResponseDto.php',
    'OneProductFoundedResponseDto' => $baseDir . '/src/dto/response_dto/OneProductFoundedResponseDto.php',
    'OneShippingMethodFoundedResponseDto' => $baseDir . '/src/dto/response_dto/OneShippingMethodFoundedResponseDto.php',
    'OneUserFoundedResponseDto' => $baseDir . '/src/dto/response_dto/OneUserFoundedResponseDto.php',
    ...
    'PasswordChangeResponseDto' => $baseDir . '/src/dto/response_dto/PasswordChangeResponseDto.php',
    ...
    'ProductBrandNameChangedSuccessfullyResponseDto' => $baseDir . '/src/dto/response_dto/ProductBrandNameChangedSuccessfulyResponseDto.php',
    ...
    'ProductConstructorRuleRequiredDecorator' => $baseDir . '/src/model/product/product_decorator/ProductConstructorRuleRequiredDecorator.php',
    'ProductController' => $baseDir . '/src/controller/ProductController.php',
    'ProductControllerFactory' => $baseDir . '/src/controller/factory/ProductControllerFactory.php',
    'ProductCreatedResponseDto' => $baseDir . '/src/dto/response_dto/ProductCreatedResponseDto.php',
    'ProductCreationalDto' => $baseDir . '/src/dto/request_dto/ProductCreationalDto.php',
    'ProductDao' => $baseDir . '/src/data_acces_layer/ProductDao.php',
    'ProductDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/ProductDaoImpl.php',
    'ProductDecorator' => $baseDir . '/src/model/product/product_decorator/ProductDecorator.php',
    'ProductDeletedResponseDto' => $baseDir . '/src/dto/response_dto/ProductDeletedResponseDto.php',
    'ProductDescriptionChangedResponseDto' => $baseDir . '/src/dto/response_dto/ProductDescriptionChangedResponseDto.php',
    ...
    'ProductForCreatingCategoryDecorator' => $baseDir . '/src/model/product/product_decorator/ProductForCreatingCategoryDecorator.php',
    'ProductHeaderChangedResponseDto' => $baseDir . '/src/dto/response_dto/ProductHeaderChangedResponseDto.php',
    'ProductInMemoryDaoImpl' => $baseDir . '/src/data_acces_layer/in_memory_implemantation/ProductInMemoryDaoImpl.php',
    'ProductInMemoryDaoTest' => $baseDir . '/src/tests/integration/data_acces/product/ProductInMemoryDaoTest.php',
    'ProductInterface' => $baseDir . '/src/model/product/ProductInterface.php',
    'ProductModelNameChangedResponseDto' => $baseDir . '/src/dto/response_dto/ProductModelNameChangedResponseDto.php',
    'ProductPriceChangedResponseDto' => $baseDir . '/src/dto/response_dto/ProductPriceChangedResponseDto.php',
    'ProductRepository' => $baseDir . '/src/repository/ProductRepository.php',
    'ProductRepositoryAggregateRootDecorator' => $baseDir . '/src/repository/repository_decorator/aggregate_root_decorator/ProductRepositoryAggregateRootDecorator.php',
    'ProductRepositoryDecorator' => $baseDir . '/src/repository/repository_decorator/ProductRepositoryDecorator.php',
    'ProductRepositoryImpl' => $baseDir . '/src/repository/Implemantions/ProductRepositoryImpl.php',
    'ProductService' => $baseDir . '/src/service/ProductService.php',
    'ProductServiceDecorator' => $baseDir . '/src/service/service_decorator/ProductService/ProductServiceDecorator.php',
    'ProductServiceFactory' => $baseDir . '/src/service/factory/ProductServiceFactory.php',
    'ProductServiceImpl' => $baseDir . '/src/service/Implemantions/ProductServiceImpl.php',
    'ProductStockQuantityChangedResponseDto' => $baseDir . '/src/dto/response_dto/ProductStockQuantityChangedResponseDto.php',
    'ProductSubscriber' => $baseDir . '/src/model/product/ProductSubscriber.php',
    'ProductSubscriberCreatedResponseDto' => $baseDir . '/src/dto/response_dto/ProductSubscriberCreatedResponseDto.php',
    'ProductSubscriberCreationalDto' => $baseDir . '/src/dto/request_dto/ProductSubscriberCreationalDto.php',
    'ProductSubscriberDeletedResponseDto' => $baseDir . '/src/dto/response_dto/ProductSubscriberDeletedResponseDto.php',
    'ProductSubscriberFactory' => $baseDir . '/src/model/product/factory/ProductSubscriberFactory.php',
    'ProductSubscriberInterface' => $baseDir . '/src/model/product/ProductSubscriberInterface.php',
    'ProductSubscriberRepository' => $baseDir . '/src/repository/ProductSubscriberRepository.php',
    'ProductSubscriberRepositoryImpl' => $baseDir . '/src/repository/Implemantions/ProductSubscriberRepositoryImpl.php',
    ...
    'RateCollection' => $baseDir . '/src/model/product/iterator_aggregates/RateCollection.php',
    'RateDao' => $baseDir . '/src/data_acces_layer/RateDao.php',
    'RateDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/RateDaoImpl.php',
    'RateFactory' => $baseDir . '/src/model/product/factory/RateFactory.php',
    'RateInMemoryDaoImpl' => $baseDir . '/src/data_acces_layer/in_memory_implemantation/RateInMemoryDaoImpl.php',
    'RateInMemoryDaoTest' => $baseDir . '/src/tests/integration/data_acces/rate/RateInMemoryDaoTest.php',
    'RateInterface' => $baseDir . '/src/model/product/RateInterface.php',
    'RateRepository' => $baseDir . '/src/repository/RateRepository.php',
    'RateRepositoryImpl' => $baseDir . '/src/repository/Implemantions/RateRepositoryImpl.php',
    ...
    'RefreshTokenDao' => $baseDir . '/src/data_acces_layer/RefreshTokenDao.php',
    'RefreshTokenDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/RefreshTokenDaoImpl.php',
    'RefreshTokenDto' => $baseDir . '/src/dto/request_dto/RefreshTokenDto.php',
    'RefreshTokenExpireTimeEndedException' => $baseDir . '/src/exception/RefreshTokenExpireTimeEndedException.php',
    'RefreshTokenFactory' => $baseDir . '/src/model/user/factory/RefreshTokenFactory.php',
    'RefreshTokenFactoryTest' => $baseDir . '/src/tests/unit/model/refresh_token/RefreshTokenFactoryTest.php',
    'RefreshTokenInterface' => $baseDir . '/src/model/user/RefreshTokenInterface.php',
    'RefreshTokenResponseDto' => $baseDir . '/src/dto/response_dto/RefreshTokenResponseDto.php',
    ...
    'ResponseViewModel' => $baseDir . '/src/dto/response_abstraction/ResponseViewModel.php',
    ...
    'SameDayShippingFactory' => $baseDir . '/src/model/shipping/factory/SameDayShippingFactory.php',
    'SamePropertyException' => $baseDir . '/src/exception/SamePropertyException.php',
    'SearchedProductResponseDto' => $baseDir . '/src/dto/response_dto/SearchedProductResponseDto.php',
    ...
    'SendPriceReducedEmailDto' => $baseDir . '/src/dto/request_dto/SendPriceReducedEmailDto.php',
    'SetNumCommandStub' => $baseDir . '/src/tests/unit/stubs/HelloWorldControllerCommandStub.php',
    'Shipping' => $baseDir . '/src/model/shipping/Shipping.php',
    'ShippingCollection' => $baseDir . '/src/model/shipping/iterator_aggregate/ShippingCollection.php',
    'ShippingController' => $baseDir . '/src/controller/ShippingController.php',
    'ShippingControllerFactory' => $baseDir . '/src/controller/factory/ShippingControllerFactory.php',
    'ShippingDao' => $baseDir . '/src/data_acces_layer/ShippingDao.php',
    'ShippingDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/ShippingDaoImpl.php',
    'ShippingFactoryContext' => $baseDir . '/src/model/shipping/factory/ShippingFactoryContext.php',
    'ShippingInterface' => $baseDir . '/src/model/shipping/ShippingInterface.php',
    'ShippingRepository' => $baseDir . '/src/repository/ShippingRepository.php',
    'ShippingRepositoryImpl' => $baseDir . '/src/repository/Implemantions/ShippingRepositoryImpl.php',
    'ShippingService' => $baseDir . '/src/service/ShippingService.php',
    'ShippingServiceDecorator' => $baseDir . '/src/service/service_decorator/ShippingService/ShippingServiceDecorator.php',
    'ShippingServiceImpl' => $baseDir . '/src/service/Implemantions/ShippingServiceImpl.php',
    'ShippingType' => $baseDir . '/src/model/shipping/ShippingType.php',
    'SqliteInMemoryConnection' => $baseDir . '/src/data_acces_layer/DatabaseConnections/SqliteInMemoryConnection.php',
    'StockQuantityChangingConstant' => $baseDir . '/src/dto/request_dto/ChangeProductStockQuantityDto.php',
    ...
    'TransactionalCategoryServiceDecorator' => $baseDir . '/src/service/service_decorator/CategoryService/TransactionalCategoryServiceDecorator.php',
    'TransactionalImageServiceDecorator' => $baseDir . '/src/service/service_decorator/ImageService/TransactionalImageServiceDecorator.php',
    'TransactionalProductServiceDecorator' => $baseDir . '/src/service/service_decorator/ProductService/TransactionalProductServiceDecorator.php',
    'TransactionalShippingServiceDecorator' => $baseDir . '/src/service/service_decorator/ShippingService/TransactionalShippingServiceDecorator.php',
    ...
    'TwoDayShippingFactory' => $baseDir . '/src/model/shipping/factory/TwoDayShippingFactory.php',
    'UnhandledMatchError' => $vendorDir . '/symfony/polyfill-php80/Resources/stubs/UnhandledMatchError.php',
    'UpdateCategoryNameByUuidCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/CategoryController/UpdateCategoryNameByUuidCommand.php',
    'UpdateCategoryNameByUuidDto' => $baseDir . '/src/dto/request_dto/UpdateCategoryNameByUuidDto.php',
    'UpdateProductBrandNameCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/UpdateProductBrandNameCommand.php',
    'UpdateProductDescriptionCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/UpdateProductDescriptionCommand.php',
    'UpdateProductHeaderCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/UpdateProductHeaderCommand.php',
    'UpdateProductModelNameCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/UpdateProductModelNameCommand.php',
    'UpdateProductPriceCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/UpdateProductPriceCommand.php',
    'UpdateProductStockQuantityCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ProductController/UpdateProductStockQuantityCommand.php',
    'UploadImageForProductCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/ImageController/UploadImageForProductCommand.php',
    'UploadService' => $baseDir . '/src/service/UploadService.php',
    'UploadServiceImpl' => $baseDir . '/src/service/Implemantions/UploadServiceImpl.php',
    ...
    'UserCreatedResponseDto' => $baseDir . '/src/dto/response_dto/UserCreatedResponseDto.php',
    'UserCreationalDto' => $baseDir . '/src/dto/request_dto/UserCreationalDto.php',
    'UserDao' => $baseDir . '/src/data_acces_layer/UserDao.php',
    'UserDaoImpl' => $baseDir . '/src/data_acces_layer/Implemantions/UserDaoImpl.php',
    'UserFactory' => $baseDir . '/src/model/user/factory/UserFactory.php',
    'UserFactoryTest' => $baseDir . '/src/tests/unit/model/user/UserFactoryTest.php',
    'UserInterface' => $baseDir . '/src/model/user/UserInteface.php',
    'UserLogedInResponseDto' => $baseDir . '/src/dto/response_dto/UserLogedInResponseDto.php',
    'UserLoginDto' => $baseDir . '/src/dto/request_dto/UserLoginDto.php',
    ...
    'ValueMustBeLessThanException' => $baseDir . '/src/exception/ValueMustBeLessThanException.php',
    'VerifyUserAccountCommand' => $baseDir . '/src/front_controller/front_controller_command/controller_commands/AuthController/VerifyUserAccountCommand.php',
);
